...
Version  : 1.14.1
Release  : 24
URL      : https://github.com/hercules-team/augeas/archive/release-1.14.1/augeas-1.14.1.tar.gz
Source0  : https://github.com/hercules-team/augeas/archive/release-1.14.1/augeas-1.14.1.tar.gz
Source1  : https://github.com/coreutils/gnulib/archive/refs/tags/v1.0.tar.gz
Summary  : Augeas configuration editing library
...
Patch1: 0001-Assume-gnulib-location.patch
...
%prep
%setup -q -n augeas-release-1.14.1
cd %{_builddir}
tar xf %{_sourcedir}/v1.0.tar.gz
cd %{_builddir}/augeas-release-1.14.1
mkdir -p .gnulib
cp -r %{_builddir}/gnulib-1.0/. %{_builddir}/augeas-release-1.14.1/.gnulib
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738884459
...
cp %{_builddir}/augeas-release-%{version}/COPYING %{buildroot}/usr/share/package-licenses/augeas/0bf81afbc585fd8fa3a9267d33498831f5a5c9c2 || :
cp %{_builddir}/gnulib-1.0/doc/COPYING.LESSERv2 %{buildroot}/usr/share/package-licenses/augeas/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
cp %{_builddir}/gnulib-1.0/doc/COPYING.LESSERv3 %{buildroot}/usr/share/package-licenses/augeas/a8a12e6867d7ee39c21d9b11a984066099b6fb6b || :
cp %{_builddir}/gnulib-1.0/doc/COPYINGv2 %{buildroot}/usr/share/package-licenses/augeas/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/gnulib-1.0/doc/COPYINGv3 %{buildroot}/usr/share/package-licenses/augeas/31a3d460bb3c7d98845187c716a30db81c44b615 || :
export GOAMD64=v2
GOAMD64=v2
%make_install
...
/usr/share/augeas/lenses/dist/authinfo2.aug
/usr/share/augeas/lenses/dist/authorized_keys.aug
/usr/share/augeas/lenses/dist/authselectpam.aug
...
/usr/share/augeas/lenses/dist/fail2ban.aug
...
/usr/share/augeas/lenses/dist/sos.aug
...
/usr/share/augeas/lenses/dist/tests/test_authinfo2.aug
/usr/share/augeas/lenses/dist/tests/test_authorized_keys.aug
/usr/share/augeas/lenses/dist/tests/test_authselectpam.aug
...
/usr/share/augeas/lenses/dist/tests/test_fail2ban.aug
...
/usr/share/augeas/lenses/dist/tests/test_sos.aug
...
/usr/share/augeas/lenses/dist/tests/test_tinc.aug
...
/usr/share/augeas/lenses/dist/tinc.aug
...
/usr/share/bash-completion/completions/augmatch
/usr/share/bash-completion/completions/augprint
/usr/share/bash-completion/completions/augtool
...
/usr/lib64/libaugeas.so.0.25.0
/usr/lib64/libfa.so.1
/usr/lib64/libfa.so.1.5.3

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/augeas/01a6b4bf79aca9b556822601186afab86e8c4fbf
/usr/share/package-licenses/augeas/0bf81afbc585fd8fa3a9267d33498831f5a5c9c2
/usr/share/package-licenses/augeas/31a3d460bb3c7d98845187c716a30db81c44b615
/usr/share/package-licenses/augeas/4cc77b90af91e615a64ae04893fdffa7939db84c
/usr/share/package-licenses/augeas/a8a12e6867d7ee39c21d9b11a984066099b6fb6b

%files man
%defattr(0644,root,root,0755)
/usr/share/man/man1/augmatch.1
/usr/share/man/man1/augparse.1
/usr/share/man/man1/augprint.1
